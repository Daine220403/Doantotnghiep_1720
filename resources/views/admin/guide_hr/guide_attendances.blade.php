    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <div class="btn-group" role="group">
                <a href="{{ route('guide.attendances.index', ['month' => $prevMonth->month, 'year' => $prevMonth->year]) }}" class="btn btn-sm btn-outline-secondary">&laquo; Tháng trước</a>
                <a href="{{ route('guide.attendances.index', ['month' => $today->month, 'year' => $today->year]) }}" class="btn btn-sm btn-outline-primary">Hôm nay</a>
                <a href="{{ route('guide.attendances.index', ['month' => $nextMonth->month, 'year' => $nextMonth->year]) }}" class="btn btn-sm btn-outline-secondary">Tháng sau &raquo;</a>
            </div>
        </div>
        <div class="card-body">
            @if (session('success'))
