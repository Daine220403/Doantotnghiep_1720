...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseUser" class="collapse" aria-labelledby="headingUser" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Chức năng tài khoản:</h6>
                    <a class="collapse-item" href="{{ route('admin.mana-user.index') }}">Danh sách tài khoản</a>
                    <a class="collapse-item" href="{{ route('admin.mana-user.create') }}">Thêm tài khoản</a>
                </div>
            </div>
        </li>
    @endif
    ...
    @if (in_array(Auth::user()->role, ['partner', 'admin']))
        ...
        <!-- Nav Item - Hiring Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseRolePartner"
                aria-expanded="true" aria-controls="collapseRolePartner">
                <i class="fas fa-user-friends"></i>
                <span>Đối tác dịch vụ</span>
            </a>
            <div id="collapseRolePartner" class="collapse" aria-labelledby="headingUtilities"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
